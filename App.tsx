...
const POSE_INSTRUCTIONS = [
  ...
  "Chụp nghiêng",
  "Nhảy lên không, chụp khoảnh khắc",
...
const App: React.FC = () => {
  ...
  const handleGarmentSelect = useCallback(async (garmentFile: File, garmentInfo: WardrobeItem) => {
    ...
    try {
      ...
      setError(getFriendlyErrorMessage(err, 'Không thể áp dụng trang phục'));
    } finally {
      setIsLoading(false);
      setLoadingMessage('');
    }
            ...
            <main className="flex-grow relative flex flex-col md:flex-row overflow-hidden">
              ...
              >
                  <button 
                    ...
                    aria-label={isSheetCollapsed ? 'Mở rộng bảng điều khiển' : 'Thu gọn bảng điều khiển'}
                  >
