...
const REMIX_SUGGESTIONS = [
  "Ý tưởng remix: Tạo một lookbook có thể chia sẻ.",
  "Ý tưởng remix: Tích hợp API e-commerce để tìm các mặt hàng tương tự.",
  "Ý tưởng remix: Thêm phụ kiện như mũ, kính râm hoặc túi xách.",
  "Ý tưởng remix: Tạo 'điểm phong cách' cho các bộ trang phục.",
  "Ý tưởng remix: Cho phép người dùng lưu các bộ trang phục yêu thích của họ.",
  "Ý tưởng remix: Tạo các phối màu khác nhau cho quần áo.",
];
